			...
			<div id="about">
				...
				<span id="person">
					<p id="line">
						...
						I enjoy teaching code as much  than I enjoy coding itself. I intend to code until my fingers stop complying but I really want to lead teams in development and become a mentor/teacher for those interested. For this reason, my absolute favorite position was with Razu Inc. At Razu,I oriented new developers with the Mean stack using Angular 2 as well as coded a vast majority of the project to build a social network for artists to collaborate on projects and promote themselves.
