				...
				<div id="slider">
					<div id="encapsulation" className="slide">
						<div className="top">
							...
							<a href="/assets/encapsulation.png" data-title="Video & Music Components"  className="right">
					...
					<div id="sockets" className="slide">
						<div className="top">
							...
							<a  href="/assets/sockets.png" data-title="Chat"  className="right">
					...
					<div id="UI" className="slide">
						<div className="top">
							...
							<a  href="/assets/razu.png" data-title="Video & Music Components" className="right"></a>	
						</div>
						<a  href="/assets/profile.png" data-title="Video & Music Components" className="bottom">
						</a>
					</div>	
